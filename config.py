...
def credentials_file() -> str:
    return load().get("credentials_file", DEFAULT_CLIENT_SECRET)

def token_file() -> str:
    """Token luôn lưu tại thư mục gốc của dự án."""
    return os.path.join(os.path.dirname(os.path.abspath(__file__)), DEFAULT_TOKEN_FILE)
